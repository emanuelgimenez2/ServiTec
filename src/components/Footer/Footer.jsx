    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section services">
          ...
          <ul>
            ...
            <li>
              <a href="#apps-moviles">Apps Móviles</a>
            </li>
            <li>
              <a href="#consultoria">Consultoría IT</a>
            </li>
            <li>
      ...
      <div className="footer-credits">
        <div className="container">
          <p>
            Diseñado y desarrollado con <span className="heart">❤️</span> por{" "}
            <a
          ...
          <p className="credits-contact">
            ...
            <a href="mailto:tu-email@ejemplo.com">Contáctame</a>
          </p>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>
            &copy; {new Date().getFullYear()} ServiTec. Todos los derechos
            reservados.
          </p>
